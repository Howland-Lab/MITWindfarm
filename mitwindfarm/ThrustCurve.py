...
class ThrustCurve_IEA15MW(ThrustCurve):
    def __init__(self):
        self.cutin_ws = 3
        self.rated_ws = 10.59
        self.windspeeds = [ 0.        ,  0.6       ,  1.2       ,  1.8       ,  2.4       ,
        ...
        self.ctprimes =    [1.00000000e-05, 1.00000000e-05, 1.00000000e-05, 1.00000000e-05,
